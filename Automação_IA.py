#ANTES DE IMPLEMENTAR É IMPORTANTE/NECESSÁRIO QUE VOCE INSTALE AS BIBLIOTECAS E COLOQUE SUAS CREDENCIAIS DE FORMA CORRETA, UTILIZANDO GOOGLE CLOUD, BAIXE O JSON DA CONTA DE FATURAMENTO E COLOQUE O DIRETORIO DELE
# ESSE CODIGO ESTÁ EM DESENVOLVIMENTO, SOU INICIANTE NESSE RAMO DE AUTOMAÇÕES UTILIZANDO I.A ENTAO ESPERO QUE ENTENDAM QUALQUER POSSIVEL ERRO NO CODIGO, TENHO CERTEZA QUE NO FUTURO IRÁ TER CODIGOS MELHORES PARA SER APRESENTADOS.
# ESSE É APENAS UM PILOTO DE UM PROJETO FUTURO MEU QUE SE FOR POSSIVEL DISPONIBILIZAREI NO GITHUB ALGUMAS PARTES DESSE PROJETO.  
